...
model_name = "restnet18" # Define model_name here
...
torch.save(model.state_dict(), f"/content/drive/MyDrive/cs6073/NeuroFace/src/{model_name}_neuroface_best_model.pth")
print(f"Saved best model as /content/drive/MyDrive/cs6073/NeuroFace/src/{model_name}_neuroface_best.pth")
